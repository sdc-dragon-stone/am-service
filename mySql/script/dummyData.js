...
function createReview(amount, id) {
  ...
  for (var k = 0; k < amount; k++) {
    ...
    id++;
    bulkReview.push(tempReview);
  }
  var data = {};
  data.reviews = bulkReview;
  data.subReviews = reviewArray;
  return data;
}
